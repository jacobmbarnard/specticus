...
[![GitHub release](https://img.shields.io/github/v/release/jacobmbarnard/specticus?include_prereleases&sort=semver)](https://github.com/jacobmbarnard/specticus/releases)
...
[![Windows](https://img.shields.io/badge/Windows-TBD-lightgrey)](https://github.com/jacobmbarnard/specticus/issues/62)

Prebuilt archives ship on each tagged release (`v*`) via the **Release binaries** workflow (see [docs/binaries.md](docs/binaries.md)). Platform badges reflect the current release matrix; **Windows** packaging is tracked in [#62](https://github.com/jacobmbarnard/specticus/issues/62).
